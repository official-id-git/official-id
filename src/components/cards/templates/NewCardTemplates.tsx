...
const getSocialIcon = (platform: string) => {
    const iconMap: { [key: string]: React.ReactElement } = {
        ...
        telegram: <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 24c6.627 0 12-5.373 12-12S18.627 0 12 0 0 5.373 0 12s5.373 12 12 12zm5.894-15.312-1.928 9.079c-.144.646-.525.807-1.062.505l-2.936-2.16-1.418 1.366c-.157.156-.289.288-.592.288l.211-2.977 5.418-4.897c.236-.21-.051-.326-.366-.118l-6.696 4.218-2.887-.905c-.628-.198-.64-.627.132-.934l11.272-4.343c.522-.192.98.114.852.878z" /></svg>,
        gdrive: <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12.01 1.49l-6.12 10.6 3.06 5.3 6.12-10.6-3.06-5.3zM13.56 18.99h10.43l-3.07-5.3h-10.42l3.06 5.3zm-7.65-5.3L-.01 18.99h6.12l5.88-10.18-5.9-5.12z" /></svg>,
        behance: <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M22 7h-7v-2h7v2zm1.726 10c-.442 1.297-2.029 3-5.101 3-3.074 0-5.564-1.729-5.564-5.675 0-3.91 2.325-5.92 5.466-5.92 3.082 0 4.964 1.882 5.344 5.213.04.346.06.749.06 1.182h-7.904c.148 2.017 1.498 3.12 3.167 3.12 1.348 0 2.228-.621 2.684-1.503l2.848.583zm-5.498-5c-.172-1.325-1.129-2.126-2.39-2.126-1.309 0-2.348.918-2.528 2.126h4.918zm-15.688-6h6.295c2.408 0 4.143 1.259 4.143 3.518 0 1.638-1.042 2.677-2.227 3.018 1.464.218 2.651 1.246 2.651 3.232 0 2.45-1.921 3.732-4.417 3.732h-6.445v-13.5h.001zm3.321 5.308h2.094c1.239 0 2.046-.575 2.046-1.765 0-1.229-.817-1.685-1.892-1.685h-2.248v3.45zm0 5.692h2.518c1.378 0 2.325-.565 2.325-2.029 0-1.424-.958-2.02-2.385-2.02h-2.458v4.049z" /></svg>
    }
