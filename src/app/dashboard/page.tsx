...
import { MessageCircle, CreditCard, Pencil, Share2 } from 'lucide-react'
...
export default function DashboardPage() {
  ...
  return (
    <div className="px-2 space-y-6 -mt-4">
      ...
      {/* Information Card - Share Your Digital Business Card */}
      <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-5 border border-emerald-200 shadow-sm">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-base font-semibold text-gray-800">Bagikan Kartu Nama Digital Anda</h3>
        </div>

        <p className="text-sm text-gray-600 mb-4">
          Bagikan dengan mudah kartu nama digital anda dengan satu langkah sederhana:
        </p>

        {/* Tip 1 - WhatsApp Sharing */}
        <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 mb-3 border border-emerald-100">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-gray-700 leading-relaxed">
                Kepada yang meminta kartu nama anda, sampaikan agar chat WhatsApp
                <span className="font-semibold text-emerald-700"> username kartu nama digital official.id anda </span>
                ke nomor WhatsApp:
              </p>
              <a
                href="https://wa.me/6289502008950"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 mt-2 px-4 py-2 bg-green-500 text-white text-sm font-semibold rounded-lg hover:bg-green-600 transition-colors"
              >
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-emerald-100">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-gray-700 leading-relaxed">
                Username kartu nama digital official.id anda belum unik? Mari kita ganti:
              </p>
              <ol className="mt-2 space-y-1.5 text-sm text-gray-600">
                <li className="flex items-center gap-2">
                  ...
                  <span>Pada menu <CreditCard className="inline w-4 h-4 text-blue-500 mx-1" /> <strong>Cards</strong>, pilih kartu nama digital anda</span>
                </li>
                <li className="flex items-center gap-2">
                  ...
                  <span>Tap tombol <Pencil className="inline w-4 h-4 text-blue-500 mx-1" /> <strong>Edit</strong></span>
                </li>
                <li className="flex items-center gap-2">
                  ...
                  <span>Ganti username random jadi username yang mudah diingat</span>
                </li>
              </ol>
            </div>
          </div>
