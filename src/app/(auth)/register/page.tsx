    ...
    <div className="min-h-screen flex overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-teal-100 text-sm">Create digital business cards at no cost</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold">Instant QR Code</h3>
                <p className="text-teal-100 text-sm">Share your profile with a QR code scan</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-teal-100 text-sm">Connect with thousands of professionals</p>
              </div>
            </div>
          </div>
          ...
          >
            <p className="italic mb-4">&quot;Official ID helped me connect with new clients in a professional and modern way.&quot;</p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500">Join Official ID</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2D7C88] focus:border-transparent"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2D7C88] focus:border-transparent"
                  required
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full text-white py-3.5 rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed transform hover:-translate-y-0.5 font-medium mt-2"
              style={{
                background: 'linear-gradient(135deg, #2D7C88 0%, #236B76 100%)',
                boxShadow: '0 10px 25px rgba(45, 124, 136, 0.3)'
              }}
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3.5 border-2 border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all duration-200"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3.5 border-2 border-gray-200 rounded-xl hover:bg-[#0077B5] hover:border-[#0077B5] hover:text-white transition-all duration-200 mt-3"
          >
          ...
          <p className="text-center mt-6 text-gray-600">
            ...
            <Link href="/login" className="text-[#2D7C88] hover:underline font-medium">
              Sign In
            </Link>
          </p>
        </div>
